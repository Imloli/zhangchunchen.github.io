define([], function(){
    ...
    var renderDOM = function(){
        ...
        var searchStr = '<form id="search-form_mobile"  class="search_mobile"><input type="text" id="st-search-input_mobile" name="q" results="0" class="st-default-search-input_mobile" maxlength="50" placeholder="搜索..." autocomplete="off" autocorrect="off"><i class="fa fa-times" onclick="resetSearch_mobile()"></i><p id="search_hint" class="search-hint">向右滑动结果打开链接</p><div id="local-search-result_mobile"></div><p class="no-result">啊哦。。。<br/>没有符合条件的文章∠( ᐛ 」∠)＿</p></form>'
        ...
        //var musicStr= '<div id="player_bck_mobile" class="aplayer"></div>';
        ...
        //$.getScript("/js/music.js",function(){
  		//	musicplayer('player_bck_mobile',false,0,true,'metedata','500px',music_bck);
		//})
    };
